...
We first need to look at the interaction terms.
While the three-way interaction between the inoculation method, thickness, and week is not significant, all three two-way interactions between these variables are.
