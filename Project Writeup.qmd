...
data <- data.frame(
  Model = c("VC", "UN", "CS", "AR(1)", "ARH(1)", "ANTE", "TOEP"),
  AIC = c(-12.2, -44.2, -17.6, -18.9, -26.6, -28.6, -19.3),
  AICC = c(-12.1, -12.2, -11.3, -12.5, -11.0, -5.4, -6.2),
  BIC = c(-13.0, -18.5, -12.8, -14.0, -15.3, -12.5, -9.7)
)

# Create and format the table
data %>%
  kable("html", caption = "Model Comparison Table") %>%
